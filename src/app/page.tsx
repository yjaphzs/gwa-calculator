...
import { CalculatorSkeleton } from "@/components/smart/calculator-skeleton";
...
function App() {
    ...
    // Unified persistence: localStorage when signed out, Firestore (live sync)
    // when signed in. Same dispatcher API as useState so the wiring below is
    // unchanged from the original localStorage-only version.
    const {
        subjects,
        setSubjects,
        removeSubjects,
